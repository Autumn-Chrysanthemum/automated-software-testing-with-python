...
class AppTest(TestCase):
    ...
    def test_menu_calls_ask_creat_post(self):
        with patch("builtins.input") as mocked_input:
            with patch('app.ask_create_post') as mocked_ask_create_post:
                mocked_input.side_effect = ('p','Test','New Post', 'Test content', "q")
                app.menu()
    ...
    def test_ask_create_blog(self):
        with patch("builtins.input") as mocked_input:
            mocked_input.side_effect = ("Test", "Test Author") #return value Test first time, value Test Author second time and so on
            app.ask_create_blog()
